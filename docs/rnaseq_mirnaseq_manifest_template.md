...
| library_selection | True | Library selection method. "Random Fragmentation" indicates libraries generated by shearing or chemical fragmentation (e.g., alkaline hydrolysis) rather than a targeted enrichment/selection step. | "Affinity Enrichment", "Hybrid Selection", "miRNA Size Fractionation", "PCR", "Poly-T Enrichment", "Random Fragmentation","rRNA Depletion", "Ribosome-protected fragments", "Other" | string | PCT | |
